...
const PatientCard = ({ patients, appointments, doctorId }) => {
  ...
  }, [appointments, doctorId, patients])
      ...
      <div className="card_group">
        <div className="card">
          {filteredPatients.map((patient, index) => (
            <>
              <div className="card" key={patient.patientId || index}>
                ...
                </div>                <div className="card__title">{patient.name}</div>
                <div className="card__subtitle">{patient.dateOfBirth}</div>
